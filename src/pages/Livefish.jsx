...
export default function LiveFish() {
  ...
  const  categoryName  = useParams().categoryName; // Default to "live-fishes" if no category is provided
  ...
  return (
    <div className="p-6 ">
      <h1 className="text-3xl font-bold text-center text-black-100 mb-6">
        {categoryName ? categoryName.charAt(0).toUpperCase() + categoryName.slice(1) : "Live Fishes"}
      </h1>
